$(document).ready(function(e) {
		...
		var CalendarHandler = {
			...
			initialize: function() {
				...
				$("#context").css("height", $("#CalendarMain").height() - 85 + "px");
				$("#center").css("height", $("#context").height() - 20 + "px");
				$("#selectYearDiv").css("height", $("#context").height() - 40 + "px").css("width", $("#context").width() + "px");
				$("#selectMonthDiv").css("height", $("#context").height() - 40 + "px").css("width", $("#context").width() + "px");
				$("#centerCalendarMain").css("height", $("#context").height() - 40 + "px").css("width", $("#context").width() + "px");

				$calendarItem.css("height", $("#context").height() - 40 + "px"); //.css2("visibility","hidden");
